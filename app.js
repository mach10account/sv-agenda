...
import { sb, app, stato, esc, pagina, erroreBox } from "./core.js?v=20";
import { mostraAgenda } from "./agenda.js?v=20";
import { mostraConversazioni } from "./conversazioni.js?v=20";
import { caricaCatalogo, mostraCorsi, mostraCorso, mostraLezione, fermaWatermark } from "./academy.js?v=20";
import { mostraAssistente } from "./assistente.js?v=20";
import { mostraIntegrazioni } from "./integrazioni.js?v=20";
...
const MARCHIO_GRANDE =
  `<img class="marchio-grande" src="logo.png?v=20" alt="Estetista Indipendente"
